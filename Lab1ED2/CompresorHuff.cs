...
namespace Lab1ED2
{
    public class CompresorHuff: CompresorInterfaz
    {
        ...
        public void Comprimir(string dirLectura, string dirEscritura, string nombreCompresion)
        {
            ...
            BinaryWriter bwEncabezado = new BinaryWriter(new FileStream(dirEscritura + nombreCompresion + ".txt", FileMode.Create));
            ...
            bwEncabezado.Close();
            BinaryWriter bw = new BinaryWriter(new FileStream(dirEscritura + nombreCompresion + ".txt", FileMode.OpenOrCreate));
            bw.Close();
            ...
            do
            {
                ...
                for (int i = 0; i < cantidadLeida; i++)
                {
                    ...
                    if (sb.Length > tamanioBuffer)
                    {
                        ...
                        bw = new BinaryWriter(new FileStream(dirEscritura + nombreCompresion + ".txt", FileMode.OpenOrCreate));
            ...
            FileInfo archivoComprimidoinf = new FileInfo(dirEscritura + nombreCompresion + ".txt");
